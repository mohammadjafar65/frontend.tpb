      ...
      <div className="row y-gap-10 justify-between items-center">
        ...
        <div className="col-auto">
          <div className="d-flex items-center js-counter">
            <button
              className="button -outline-blue-1 text-blue-1 size-38 p-0 bg-light rounded-4 js-down"
            ...
            {/* counter text  */}
            <button
              className="button -outline-blue-1 text-blue-1 size-38 p-0 bg-light rounded-4 js-up"
    ...
    <div className="searchMenu-guests px-20 py-10 border-light rounded-4 js-form-dd js-form-counters">
      ...
      >
        ...
        <div className="text-15 text-light-1 ls-2 lh-16">
          <span className="js-count-adult">{guestCounts.Guests}</span> Guests {" "}
