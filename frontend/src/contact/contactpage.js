		...
		<div className="container">
			<div className="row bg-form">
				<div className="col-lg-6 pr-5 col-md-6 col-12">
					...
					<p>Fill the form or <a href="#">Send us an email</a></p>
					<hr/>
					<div className="media">
					...
					<div className="media">
						...
						<div className="media-body">
							...
							<p><a href="mailto:hey@willburner.com">info@thepilgrimbeez.com</a></p>
						</div>
					</div>
					<div className="media">
						...
						<div className="media-body">
							...
							<p className="text-white">D98, Aman Complex, near Balas Lake, Kalikund, Dholka, Gujarat 382225</p>
						</div>
					</div>
					<div className="media">
						<img src="/img/placeholder.png" className="mr-4" alt="..."/>
